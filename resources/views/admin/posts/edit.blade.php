...
<div class="container">
    ...
    <div class="d-flex">
        ...
        <form action=" {{ route('admin.posts.update', $post->id) }} " enctype="multipart/form-data" method="POST" class="row" >
            @method('PUT')
                @csrf
                ...
                <div class="form-group col-2">
                    <img src="{{ $post->image ?? asset('storage/'.$post->image)}}" alt="preview of image" id="preview" class="img-fluid">
                </div>
